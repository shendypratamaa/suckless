...
static const char *fonts[]          = { "JetBrains Mono:size=6:style=Bold", "Hack Nerd Font Mono:size=8:style=Bold" };
static const char dmenufont[]       = "JetBrains Mono:size=6:style=Bold";
